...
export default function Movies(){
    ...
    React.useEffect(()=>{
        fetch(`https://api.themoviedb.org/3/discover/tv?api_key=${apiKey}&language=en-US&sort_by=release_date.desc&page=${page}&with_genres=${genreForURL}`)
    ...
    return(
        <div>
            <h1 className='heading'>Tv<span>SE</span>ries <span>...</span></h1>
